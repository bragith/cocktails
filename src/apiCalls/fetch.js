  ...
  let data = await (await fetch(
    url,
    {
      ...
      "headers": {
        ...
        "x-rapidapi-key": "ca3fd1a238mshe1c3ddd63ed1096p1af01bjsn8740566c429b"
      }
    })
    .then(res => res.json())
...
export const cocktailDetail = id => apiCall(`https://the-cocktail-db.p.rapidapi.com/lookup.php?i=${id}`);
